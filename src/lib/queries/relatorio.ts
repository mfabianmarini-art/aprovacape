...
export async function getRelatorio(empreendimentoId: string, de: string, ate: string) {
  ...
  return {
    periodo: { de, ate },
    atividade: [
      { rotulo: "Solicitações recebidas", valor: analises, cor: "#12455E" },
      ...
      { rotulo: "Obras concluídas e arquivadas", valor: porEvento("OBRA_CONCLUIDA"), cor: "#0E1B24" },
    ],
    totalAtendimentos: analises + reanalises,
    panorama: [
      { rotulo: "Em análise (validação documental)", valor: porStatus("ENVIADA"), cor: "#12455E" },
      { rotulo: "Em análise técnica", valor: porStatus("ANALISE"), cor: "#12455E" },
      ...
      { rotulo: "Concluídas / arquivadas", valor: porStatus("CONCLUIDA"), cor: "#0E1B24" },
