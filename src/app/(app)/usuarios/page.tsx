...
import { getUsuarios, getVinculosPendentes } from "@/lib/queries/usuarios";
...
export default async function UsuariosPage() {
  ...
  return (
    <>
      <ScreenHeader crumb="Configuração" title="Usuários e permissões" {...user} />
      <ScreenBody>
        <div style={{ display: "grid", gridTemplateColumns: "minmax(0,1fr) 330px", gap: 20, alignItems: "start" }}>
          <section style={{ background: "#fff", border: "1px solid #DDD8CE", borderRadius: 4, overflow: "hidden" }}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 165px 190px 120px", padding: "11px 18px", background: "#FAF9F6", borderBottom: "1px solid #EDE9E1", fontSize: 10.5, letterSpacing: ".13em", textTransform: "uppercase", color: "#6B7480" }}>
              <div>Usuário</div>
              <div>Perfil</div>
              <div>Vínculo</div>
              <div>Registro</div>
